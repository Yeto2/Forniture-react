...
function Popular() {
    return (
        <div className='container popular-section'>
            <div className='left'>
                <img alt='popular product image' src={require(`../images/populer-products/p1.png`)} />
                <h3>Arm Chair</h3>
                <p>Nemo enim ipsam voluptatem quia volu ptas .</p>
            </div>
            <div className='middle'>
                <div className='middle-content'>
                    <img alt='popular product image' className='middle-img' src={require(`../images/populer-products/p2.png`)} />
            ...
            <div className='right'>
                <img alt='popular product image' src={require(`../images/populer-products/p3.png`)} />
                <h3>Hanging Lamp</h3>
                <p>Nemo enim ipsam voluptatem quia volu ptas .</p>
            </div>
        </div>
